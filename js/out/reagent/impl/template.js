...
var G__24827 = o;
goog.object.set(G__24827,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__24831 = o;
goog.object.set(G__24831,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__24832__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__24833__i < G__24833__a.length) {G__24833__a[G__24833__i] = arguments[G__24833__i + 0]; ++G__24833__i;}
  args = new cljs.core.IndexedSeq(G__24833__a,0,null);
} 
return G__24832__delegate.call(this,args);};
...
return G__24832__delegate(args);
});
...
var G__24835 = props;
var G__24835__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__24835,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__24835);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__24835__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__24835__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__24836 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__24836,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__24836;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__24837){
...
var on_write = cljs.core.get.call(null,map__24838__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__24840_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24840_SHARP_);
}));
} else {
return null;
}
...
var vec__24843 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24843,(0),null);
var id = cljs.core.nth.call(null,vec__24843,(1),null);
var className = cljs.core.nth.call(null,vec__24843,(2),null);
...
var temp__5739__auto___24847 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___24847 == null)){
} else {
var key_24848 = temp__5739__auto___24847;
(jsprops.key = key_24848);
}
...
var temp__5739__auto___24849 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___24849 == null)){
} else {
var key_24850 = temp__5739__auto___24849;
(jsprops.key = key_24850);
}
...
var temp__5739__auto___24851 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___24851 == null)){
} else {
var key_24852 = temp__5739__auto___24851;
(jsprops.key = key_24852);
}
...
var G__24854 = n;
if(cljs.core._EQ_.call(null,"",G__24854)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__24854)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq24855){
var G__24856 = cljs.core.first.call(null,seq24855);
var seq24855__$1 = cljs.core.next.call(null,seq24855);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24856,seq24855__$1);
}));
...
break;
default:
var G__24862 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__24862;
continue;
...
var ctx = ({});
var vec__24864 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__24864,(0),null);
var derefed = cljs.core.nth.call(null,vec__24864,(1),null);
...
var G__24867 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24867) {
case (0):
